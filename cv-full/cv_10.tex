...
\documentclass[]{friggeri-cv} % Add 'print' as an option into the square  to remove colors from this template for printing

%\addbibresource{bibliography.bib} % Specify the bibliography file to include publications

\begin{document}

\header{Pedro}{ Alvito}{systems, control and robotics engineer} % Your name and current job title/field
...
\begin{tikzpicture}[snake=zigzag, line before snake = 10cm, line after snake = 10cm,opacity=0.6]
	...
	\draw (3,0) node[below=3pt] {$2013$} node[above=3pt] {\includegraphics[width=0.8cm,height=0.8cm]{ni}};
	\draw (5,0) node[below=3pt] {} node[above=3pt] {\includegraphics[width=0.8cm,height=0.8cm]{kth}};
	\draw (8,0) node[below=3pt] {$2015$} node[above=3pt] {\includegraphics[width=1.4cm,height=0.5cm]{semcon}};
	\draw (10,0) node[below=3pt] {$2016$} node[above=3pt] {\includegraphics[width=0.8cm,height=0.8cm]{af}};
	\draw (13,0) node[below=3pt] {$Now$} node[above=3pt] {\includegraphics[width=1.4cm,height=0.6cm]{tobii}};
