...
\header{Pedro}{ Alvito}{systems, control and robotics engineer}
...
\begin{tikzpicture}[snake=zigzag, line before snake = 10cm, line after snake = 10cm,opacity=0.6]
	...
	\draw (13,0) node[below=3pt] {$2020$} node[above=3pt] {\includegraphics[width=1.4cm,height=0.6cm]{tobii}};
	\draw (15,0) node[below=3pt] {$Now$} node[above=3pt] {\includegraphics[width=1.4cm,height=0.6cm]{viaplay}};
...
\begin{entrylist}
	...
	\begin{wrapfigure}{r}{0.1\textwidth}
		\vspace{-20pt}
		\begin{center}
			\includegraphics[width=1.5cm,height=0.8cm]{viaplay}
		\end{center}
	\end{wrapfigure}
